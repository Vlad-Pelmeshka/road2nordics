...
<div id="splide02" class="splide">
  <div class="splide__track">
    <ul class="splide__list">
      <li style="width: 500px" class="splide__slide">
        <img src="../../assets/images/pics/slide01.jpg" alt="splide02 01">
      </li>
      <li style="width: 300px" class="splide__slide">
        <img src="../../assets/images/pics/slide02.jpg" alt="splide02 02">
      </li>
      <li style="width: 400px" class="splide__slide">
        <img src="../../assets/images/pics/slide03.jpg" alt="splide02 03">
      </li>
      <li style="width: 600px" class="splide__slide">
        <img src="../../assets/images/pics/slide04.jpg" alt="splide02 04">
      </li>
      <li style="width: 300px" class="splide__slide">
        <img src="../../assets/images/pics/slide05.jpg" alt="splide02 05">
      </li>
      <li style="width: 500px" class="splide__slide">
        <img src="../../assets/images/pics/slide06.jpg" alt="splide02 06">
      </li>
    </ul>
  </div>
</div>
