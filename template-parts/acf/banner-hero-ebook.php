...
<section class="banner-hero-ebook">
    ...
    <div class="banner-hero-ebook__inner inner">
        <div class="banner-hero-ebook__content">
            <?php if ($subtitle): ?>
                <h4 class="banner-hero-ebook__subtitle animate-title"><?php echo $subtitle; ?></h4>
            <?php endif; ?>
            <?php if ($title): ?>
                <h1 class="banner-hero-ebook__title page-title animate-title"><?php echo $title; ?></h1>
            <?php endif; ?>
            ...
            <div class="banner-hero-ebook__btn animate-btn">
                <?php if ($cta = get_field('button')): ?>
                    <a href="<?php echo $cta['url']; ?>" target="<?php echo $cta['target']; ?>"
                       class="banner-hero-ebook__cta btn-primary">
