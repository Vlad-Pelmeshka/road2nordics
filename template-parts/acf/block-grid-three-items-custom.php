...
if (is_admin()):?>
    <?php echo __('Block: Grid Three Items Custom'); ?>
<?php endif; ?>
...
?>
<section class="block-grid-three-items-custom" id="<?php if ($section_id = get_field('section_id')):?><?php echo $section_id; ?><?php endif; ?>">
